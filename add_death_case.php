...
if(isset($_POST['add'])){
 $add = "INSERT INTO covid.death_case VALUES(NULL,".$_POST['id_user'].",'".$_POST['name']."',".$_POST['age'].",'".$_POST['city']."','".$_POST['date_case']."')";
...
<form method="post">
	...
	<label>Date the death:<input type="Date" name="date_case" ></label><br><br>
